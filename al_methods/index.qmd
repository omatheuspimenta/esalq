...
mashtree --kmerlength 11 HIV/seqs/*.fasta > HIV/mashtree.dnd
# Run mashtree bootstrap mode (only 100 times in class, in pratice 1000)
mashtree_bootstrap.pl --kmerlength 11 --reps 100 HIV/seqs/*.fasta -- --min-depth 0 > HIV/mashtree.bootstrap.dnd
```

## Plotting the Trees
```{.bash code-line-numbers="|2|4|6"}
# Plot mashtree output
Rscript create_tree_HIV.R -t HIV/mashtree.dnd -a HIV/annotation.csv -o HIV/
# Plot mashtree bootstrap output
Rscript create_tree_HIV.R -t HIV/mashtree.bootstrap.dnd -a HIV/annotation.csv -o HIV/
```
