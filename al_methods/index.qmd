...
<figure class="fragment fade-out" data-fragment-index="1" 
  ...
  <a href="https://www.bioinformatics.nl/bif20306/chapter3.html" target="_blank">
    <img src="https://www.bioinformatics.nl/bif20306/_images/sars-cov-2.svg" 
...
<figure>
  <a href="https://www.bioinformatics.nl/bif20306/chapter3.html" target="_blank">
    <img src="https://www.bioinformatics.nl/bif20306/_images/tree-example.png" style="width:70%; height:auto;">
  </a>
...
## Anatomy of a Phylogenetic Tree - IV
<div style="text-align:center; width:100%; margin:auto;">

<figure>
  <a href="https://training.galaxyproject.org/training-material/topics/evolution/tutorials/abc_intro_phylo/tutorial.html" target="_blank">
    <img src="https://training.galaxyproject.org/training-material/topics/evolution/tutorials/abc_intro_phylo/images/TreeAnatomyWithOutgroup.png" style="width:90%; height:auto;">
  </a>
  <figcaption style="font-size:0.5em; margin-top:0.5em;">
...
## Anatomy of a Phylogenetic Tree - V
<div style="text-align:center; width:100%; margin:auto;">
...
- Orthologs and paralogs
  - <div style="text-align:center; width:100%; margin:auto;">
    <figure>
      <a href="https://www.bioinformatics.nl/bif20306/chapter3.html" target="_blank">
        <img src="https://www.bioinformatics.nl/bif20306/_images/ortho-para.svg" style="width:90%; height:auto;">
      </a>
      <figcaption style="font-size:0.5em; margin-top:0.5em;">
...
- Orthologs and paralogs
  - <div style="text-align:center; width:100%; margin:auto;">
    <figure>
      <a href="https://www.bioinformatics.nl/bif20306/chapter3.html" target="_blank">
        <img src="https://www.bioinformatics.nl/bif20306/_images/gene-duplication-speciation_alt.svg" style="width:90%; height:auto;">
      </a>
      <figcaption style="font-size:0.5em; margin-top:0.5em;">
        The evolutionary history of a gene that has undergone two separate duplication events. (A) The species tree (large blue cylinders) comprising species A and B and with indicated gene duplication and neo-functionalisation events leading to β and γ functions. (B) The phylogenetic tree that would be drawn for the resulting 5 genes in (A), here drawn as a cladogram.
      </figcaption>
    </figure>
    </div>
...
- <span class="fragment">
  <figure>
  <a href="https://www.bioinformatics.nl/bif20306/chapter3.html" target="_blank">
    <img src="https://www.bioinformatics.nl/bif20306/_images/bifurcating_alt.svg" width="100%">
  </a>  
    <figcaption style="font-size:0.5em; text-align:center;">
...
- Other methods: Chaos Game Representation, graph-based methods, mathematical transforms (Fourier, wavelets)
:::
...
2. Calculate Mash Distance (D)  
  ...
  - Fast approximation of mutation rate, correlates with alignment-based measures like ANI.  
...
- Both methods resample to create trees and assign confidence to internal nodes. 
...
:::{.incremental}
- Steps:
  1. Split reads into k-mers (default k = 21).  
